...
function(e) {
    function t() {
        for (var e, t = [], i = 0; i < arguments.length; i++) e = arguments[i],
    ...
    e.events = {
        ...
        listen: function(e, t, i, s) {
            e.addEventListener ? e.addEventListener(t, i, s) : e.attachEvent && (e["e" + t + i] = i, e[t + i] = function() {
        ...
        unlisten: function(e, t, i, s) {
            ...
            e.attachEvent("on" + t, e[t + i]));
            var n = this.map;
            if (n[e] && "[object Array]" === toString.call(n[e])) for (var h = 0,
            o = n[e].length; o > h; h++) {
                var r = n[e][h];
        ...
        unlistenAll: function(e) {
            var t = this.map;
            if (t[e]) for (var i = 0; i < t[e].length; i++) {
                var s = t[e][i];
    ...
    e.dom = {
        ...
        addClassName: function(e, i) { (e = t(e)) && (e.className = "" == e.className ? i: e.className + " " + i)
        },
        ...
        attr: function(e, t, i, s) {
            ...
            for (var h in n) e.setAttribute(h, n[h])
        }
    },
    e.dimension = {
        cumOffset: function(e) {
            ...
            o += e.offsetLeft || 0,
            e = e.offsetParent,
            e && (t = window.getComputedStyle(e, null), i = t.getPropertyValue("position"));
            while (e && "fixed" != i);
            return "fixed" === i && (r = !0, s = Number(t.getPropertyValue("top").slice(0, -2)), n = Number(t.getPropertyValue("left").slice(0, -2))),
            [o, h, r, s, n]
        }
    },
    e.SK = {
    ...
    e.mixin(e.Autocomplete.prototype, {
        start: function() {
            ...
            this.box && "" != this.box.value && (this.initVal = this.box.value, this.curUserQuery = this.initVal)
        },
        ...
        dbClick: function() {
            if (this.box.createTextRange) {
                ...
                e.select()
            } else this.box.setSelectionRange && this.box.setSelectionRange(0, this.box.value.length);
        ...
        onkeydown: function(t) {
            ...
            case i.ESC:
                ...
                !1;
            case i.UP:
                if (this.vis) this.upDownTag = !0,
                this.up();
                else {
                    if (this.sdiv.childNodes.length > 1 && this.lastUserQuery == this.box.value) return this.show(),
                    !1;
            ...
            case i.DOWN:
                ...
                !1;
            case i.RETURN:
                return this.vis && this.curNodeIdx > -1 && !this.select() ? (this.isIE ? t.returnValue = !1 : t.preventDefault(), !1) : !0;
            case i.BACKSPACE:
        ...
        sugReq: function() {
            document.activeElement && document.activeElement != this.box || ("" != this.box.value && this.box.value != this.initVal ? this.lastUserQuery != this.box.value && (this.upDownTag || this.doReq()) : "" != this.lastUserQuery && (this.lastUserQuery = "", this.vis && (this.hide(), this.clean()))),
            0 != this.timeoutId && clearTimeout(this.timeoutId),
            this.timeoutId = setTimeout(e.bind(this.sugReq, this), this.REQUEST_TIMEOUT)
        },
        select: function(e) {
            if (e) var t = this.LOG_MOUSE_SELECT;
            else var t = this.LOG_KEY_SELECT;
            if (this.getCurNode()) {
                var i = this.getCurNode().getAttribute(this.ITEM_TYPE),
                s = this.getCurNode().getElementsByTagName("td")[0].innerHTML.replace(/<\/?[^>]*>/g, "");
                if ("1" == i) {
                    if (s = this.getElemAttr(this.getCurNode(), this.ITEM_LINK), this.clicklog(t, "&q=" + this.curUserQuery, "&index=0", "&select=" + s, "&direct=true"), this.hide(), this.selectCallBack) return void this.selectCallBack(this.box.value, this.kf);
                    window.open(s, "_blank")
                } else try {
                    if (e) this.clicklog(t, "&q=" + this.curUserQuery, "&index=" + this.curNodeIdx, "&select=" + s),
                    this.curUserQuery = s,
                    this.openInNewWindow || (this.box.value = s);
                    else {
                        if (this.box.value != s) return ! 0;
                    ...
                    if (this.openInNewWindow) {
                        if (this.selectCallBack) return void this.selectCallBack(this.box.value, this.kf);
                        window.open(n, "_blank")
                    } else document.location = n
                } catch(e) {}
            }
            return ! 1
        },
        submitForm: function(e) {
            ...
            i = this;
            t && ("_blank" === t.getAttribute("target") && this.setOpenInNewWindow(), this.setSelectCallBack(function(e, s) {
                var n = !1,
                h = !1,
                ...
                o.value = e,
                t.keyfrom ? (r = t.keyfrom, n = r.value, r.value = s) : (a = document.createElement("input"), a.style.display = "none", a.name = "keyfrom", a.value = s),
                a && t.appendChild(a),
                t.appendChild(o),
                h = t.action,
        ...
        doReq: function() {
            ...
            var t = "eng";
            if (this.inputType) var t = this.inputType.value;
            if (this._dataCache[e]) return void this.updateCall(this._dataCache[e]);
            this.count++;
        ...
        cleanScript: function() {
            for (; this.sptDiv.childNodes.length > 0;) this.sptDiv.removeChild(this.sptDiv.firstChild)
        },
        ...
        updateContent: function() {
            this.cleanScript();
            this.box.value;
            if ("" == this.bdiv.innerHTML) return this.hide(),
            void this.clean();
            var t;
            ...
            for (var s = 0; s < children.length; s++) t = children[s],
            this.isValidNode(t) && (t.setAttribute(this.ITEM_INDEX, this.size), e.events.listen(t, "mousemove", e.bind(this.mouseMoveItem, this)), e.events.listen(t, "mouseover", e.bind(this.mouseOverItem, this)), e.events.listen(t, "mouseout", e.bind(this.mouseOutItem, this)), e.events.listen(t, "click", e.bind(this.select, this)), this.childs.push(t), this.size++);
        ...
        showContent: function() {
            ...
            t[2] ? (this.sdiv.style.position = "fixed", this.sdiv.style.top = t[1] + (this.box.offsetHeight - 1) + t[3] + this.offsetY + "px", this.sdiv.style.left = t[0] + t[4] + this.offsetX + "px") : (this.sdiv.style.position = "absolute", this.sdiv.style.top = t[1] + (this.box.offsetHeight - 1) + this.offsetY + "px", this.sdiv.style.left = t[0] + this.offsetX + "px"),
        ...
        hideOnDoc: function() {
            this.clickEnabled && (this.hide(), this.clickEnabled = !1, setTimeout(e.bind(this.enableClick, this), 60))
        },
        ...
        mouseOverItem: function(t) {
            if (this.removeBoxBlur(), !this.canMouseOver) return void(this.canMouseOver = !0);
            for (var i = e.events.element(t); i.parentNode && (!i.tagName || null == i.getAttribute(this.ITEM_INDEX));) i = i.parentNode;
            var s = i.tagName ? i.getAttribute(this.ITEM_INDEX) : -1; - 1 != s && s != this.curNodeIdx && (this.hlOff(), this.curNodeIdx = Number(s), this.hlOn(!1))
        },
        ...
        hlOn: function(t) {
            if (this.getCurNode()) {
                ...
                for (var s = 0; s < i.length; ++s) e.dom.addClassName(i[s], this.ITEM_HIGHLIGHT_STYLE)
            }
        },
        hlOff: function() {
            if (this.getCurNode()) {
                for (var t = this.getCurNode().getElementsByTagName("td"), i = 0; i < t.length; ++i) e.dom.removeClassName(t[i], this.ITEM_HIGHLIGHT_STYLE);
        ...
        up: function() {
            ...
            this.curNodeIdx > 0 ? (this.hlOff(), this.curNodeIdx = e - 1, this.hlOn(!0)) : 0 == this.curNodeIdx ? (this.hlOff(), this.curNodeIdx = e - 1, this.box.value = this.curUserQuery) : (this.curNodeIdx = this.size - 1, this.hlOn(!0))
        },
        down: function() {
            var e = this.curNodeIdx;
            this.curNodeIdx < 0 ? (this.curNodeIdx = e + 1, this.hlOn(!0)) : this.curNodeIdx < this.size - 1 ? (this.hlOff(), this.curNodeIdx = e + 1, this.hlOn(!0)) : (this.hlOff(), this.curNodeIdx = -1, this.box.value = this.curUserQuery)
        },
        ...
        updateCall: function(e) {
            var t = unescape(e);
            if (this.bdiv.innerHTML = t, this.bdiv.childNodes.length < 2) this.bdiv.innerHTML = "";
            else {
                var i, s = this.bdiv.getElementsByClassName("remindtt75"),
                n = s.length,
                h = 5,
                o = s[0].parentNode.parentNode;
                for (i = n - 1; i > h - 1; i--) o.removeChild(s[i].parentNode);
                for (n = s.length, i = 0; n > i; i++) s[i].innerHTML = s[i].innerHTML.replace(this.curUserQuery, "<span>" + this.curUserQuery + "</span>");
        ...
        focusBox: function() {
            if (this.box.focus(), this.box.createTextRange) {
                var e = this.box.createTextRange();
                e.moveStart("character", this.box.value.length),
                e.select()
            } else this.box.setSelectionRange && this.box.setSelectionRange(this.box.value.length, this.box.value.length)
        },
        pressPoint: function(t) {
            this.clickEnabled && (this.clickEnabled = !1, setTimeout(e.bind(this.enableClick, this), 20), this.clicklog(this.LOG_ICON_PRESS, "&q=" + this.box.value, "&visible=" + this.vis), this.focusBox(), this.vis ? this.hide() : this.lastUserQuery != this.box.value ? this.doReq() : "" == this.sdiv.innerHTML ? this.doReq() : this.show())
        },
        ...
        bindATagWithMouseEvent: function(t, i) {
            try {
                if (this.hideClose && t.parentNode) return void t.parentNode.removeChild(t)
            } catch(s) {}
