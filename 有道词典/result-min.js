...
function() {
    $("body").delegate("[node-type=search]", "submit",
    function() {
        var e = $(this),
        ...
        o ? (location.href = n, !1) : (location.href = "/", !1)
    })
} (),
function(e) {
    for (var t = 4,
    o = document.createElement("div"), n = o.getElementsByTagName("i"); o.innerHTML = "<!--[if gt IE " + ++t + "]><i></i><![endif]-->", n[0];);
    o = n = null;
    var i = t > 5;
    e.browser = {
        msie: i,
    ...
    e.extend({
        toggle: function() {
            e(".toggle").click(function() {
                return e(this).attr("class").indexOf("toggleOpen") < 0 ? (e(this).removeClass("toggleClose").addClass("toggleOpen"), e(e(this).attr("rel")).show()) : (e(this).removeClass("toggleOpen").addClass("toggleClose"), e(e(this).attr("rel")).hide()),
                !1
            })
        },
...
function(e, t) {
    e(function() {
        ...
        i.play = function() {
            var t = function(e) {
                var t = e;
                return e.indexOf("http://dict.youdao.com/") < 0 && (t = "https://dict.youdao.com/dictvoice?audio=" + e),
                t
            },
            n = function() {
                var e = arguments[0];
            ...
            r = function() {
                var o = arguments[0];
                stopVoice(),
                swfReady && (e("#simplayer").siblings(".close").click(), a.playVoice(t(o)))
            };
            return o ? n: r
        } (),
        e("#results-contents h2 a.voice-js").on("mouseenter",
        function(t) {
            i.play(e(this).data("rel")),
            t.preventDefault()
        }),
        e("a.voice-js,a.humanvoice-js").on("click",
        function(t) {
            i.play(e(this).data("rel")),
            t.preventDefault()
        }),
        window.stopVoice = function() {
            ...
            e.isFunction(a.pause) && (a.pause(), a.currentTime > 0 && (a.currentTime = 0))
        }
    }),
    t.swfReady = !1,
    t.jsReady = !1,
...
function(e) {
    function t(e, t) {
        for (var o = null == t ? window: t, n = e.split("."), i = 0; i < n.length; i++) o[n[i]] || (o[n[i]] = {}),
        o = o[n[i]];
        return o
    }
    t("dict.dU");
    var o = {
        ...
        tab: function() {
            ...
            return n.prototype = {
                ...
                defaultCallback: function(t, n) {
                    ...
                    i.hasClass("toggleOpen") || (i.addClass("toggleOpen"), e(i.attr("rel")).show(), o.saveToggleStatus(i));
                ...
                current: function() {
                    ...
                    void 0 !== i && (e(t + " a[rel='" + i + "']").addClass("tab-current"), e(i).addClass("current-content"), 0 === e(o + ".tab-current").size() && (e(o).eq(0).addClass("tab-current"), e(e(o).eq(0).attr("rel")).addClass("current-content")))
                },
                bind: function() {
                    var t, o, n, i, a = this.tabsContainer + " span.tabs a",
                    r = this;
                    e("#deskdict_main").delegate(a, "click",
                    function() {
                        t = e(a + ".tab-current"),
                        o = e(t.attr("rel")),
                        n = e(this),
            ...
            {
                bind: function(e, o) {
                    for (var i = e.split(","), a = 0; a < i.length; a += 1) t[i[a]] = new n(i[a], o[i[a]])
                },
                getTab: function(e) {
                    return t[e]
                },
                currents: function() {
                    for (var e in t) t.hasOwnProperty(e) && t[e].current()
                }
            }
        } (),
        collapse: function(t, o, n) {
            e("#deskdict_main").delegate(t + " " + o, "click",
            function(o) {
        ...
        toggle: function() {
            e("#deskdict_main").delegate("a.toggle", "click",
            function() {
        ...
        loadJs: function(t, o) {
            ...
            i.onload = i.onreadystatechange = function() {
                a || this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || (e.isFunction(o.successFunc) && o.successFunc(), i.onload = i.onreadystatechange = null, n && i.parentNode && n.removeChild(i), i = null, a = !0)
            },
            i.onerror = function() {
        ...
        check: function() {
            ...
            n = {
                ...
                and: function(e, n, i) {
                    for (var a in n) if (n.hasOwnProperty(a)) {
                        var r = n[a].exec ? n[a] : t[n[a]];
                        if (r.exec(""), !r.exec(i)) return o.push(a),
                        o
                    }
                    return ! 0
                }
            ...
            i = function(t, o) {
                e.isFunction(o.error) ? o.error(t) : (o.elem.addClass("data-error"), o.elem.after(r(t, o.tagName, o.className, o.msgNum)))
            },
            a = function(t) {
                o = [],
                e.isFunction(t.errorReset) ? t.errorReset() : (t.elem.removeClass("data-error"), e(t.elem.parent()).find(".error-message").remove())
            },
            r = function(e, t, o, n) {
                n = n || 0;
                for (var i = 0; i < e.length; i += 1) if (n === i + 1) return "<" + (t || "span") + ' class="' + (o || "") + ' error-message">' + e[i] + "</" + (t || "span") + ">";
                return ""
            },
            s = function(t) {
                if (0 === t.elem.size() || t.additional && t.additional()) return ! 0;
                a(t);
                var o = n[t.concat || "or"](t.elem, t.types, e.trim(t.elem.val()));
                return ! e.isArray(o) || (i(o, t), !1)
            },
            c = function(e) {
                for (var t = e.configs,
                o = 0; o < t.length; o += 1) !
            ...
            l = function(e) {
                for (var t = e.callback,
                o = e.configs,
                n = !0,
                i = 0; i < o.length; i += 1) s(o[i]) || (n = !1);
                n && t()
            },
            d = function(e) {
                this.configSet = e,
    ...
    o.Drawer.prototype = {
        ...
        setMainCatalogSelectedStatus: function(t) {
            ...
            e("#" + this.id + " .group_" + t).length > 0 ? (e(e("#" + this.id + " .main-catalog")[t - 1]).addClass("main-catalog-selected"), e("#" + this.id + " .group_" + t).show()) : e(e("#" + this.id + " .main-catalog")[t - 1]).addClass("main-catalog-selected")
        },
        setSubCatalogSelectedStatus: function() {
            ...
            for (var t = 0; t < arguments.length; t++) e("#" + this.id + " ." + arguments[t]).addClass("sub-catalog-selected")
        },
        openMainCatalog: function(t) {
            e("#" + this.id + " ." + t).click()
        },
        openSubCatalogs: function() {
            for (var t = 0; t < arguments.length; t++) e("#" + this.id + " ." + arguments[t]).click()
        },
        initMain: function(t) {
            var o = this,
    ...
    jQuery.fn.extend({
        placeHolder: function() {
            ...
            o = function(e, t) {
                ...
                n(),
                e.bind("focus.clearIt",
                function() {
                    e.val() === t.info && e.val("")
                }),
                e.bind("blur.restoreIt",
                function() {
                    "" === e.val() && n()
                }),
                e.bind("keydown",
    ...
    function() {
        ...
        e.prototype = {
            ...
            on: function(e, o) {
                ...
                o.eidx = "__eidx_" + n,
                void 0 !== r && ("undefined" == typeof this.mudules[r] && (this.mudules[r] = []), this.mudules[r].push("__eidx_" + n)),
                n++
            },
            un: function(e, o) {
                if ("undefined" == typeof e) return this.listeners = {},
                void(this.mudules = {});
                var n = t(e),
                i = n.etype,
                a = n.ns;
                if (void 0 !== this.listeners[i]) for (var r = this.listeners[i], s = this.mudules[a], c = 0, l = s.length; c < l; c++) r[s[c]] = null;
            ...
            fire: function(e) {
                ...
                if (null !== this.listeners[e.type]) {
                    ...
                    for (var o in t) t.hasOwnProperty(o) && null !== t[o] && t[o].call(this, e)
                }
            }
        },
        o.ke = function(t) {
    ...
    function() {
        ...
        var s = function(t) {
            void 0 !== t && (e(document).unbind("click.lboxClose"), t || e(document).bind("click.lboxClose",
            function(e) {
                n.close(),
                e.stopPropagation()
            }))
        ...
        o.msg.updateMsg = function(o, n, i) {
            "undefined" != typeof o && o.size ? (t.empty(), t.append(o)) : "string" == typeof o && (t.empty(), t.html(o)),
            e.isFunction(o) && (n = o),
...
function(e) {
    ...
    o = function() {
        e("#nav .product-js,#nv .product-js").click(function() {
            ...
            "" != t && (t = t.replace(/(^link:)|(^inlink:)|(^related:)|(^lj:)/, ""), this.href += o + encodeURIComponent(t) + "&keyfrom=dict.top")
        })
    }
} (jQuery),
...
function() {
    ...
    t = function() {
        youdaos && youdaos.events.listen(window, "load",
        function() {
...
function() {
    ...
    o = $(window);
    o.scroll(function(n) {
        o.scrollTop() > 53 ? (e.addClass("setTop"), t.addClass("setTop")) : (e.removeClass("setTop"), t.removeClass("setTop"))
    })
} (),
function(e) {
    var t = function() {
    ...
    a = function() {
        if (t() && 0 === e("#chromeBox").size() && "noRemind" !== e.cookie("click.noRemind")) {
            if (e("body").hasClass("t1")) var a = o(),
            r = "45px";
            else if (e("body").hasClass("t0")) var a = n(),
            r = "32px";
            e(a).animate({
                height: r
            },
    ...
    r = function() {
        ...
        e(".vote-btns").on("click", "button",
        function(t) {
            t.preventDefault(),
            e(this).hasClass("up") ? e(this).hasClass("pressed") ? (e(this).removeClass("pressed"), e.post(i, {
                clientLog: "cancel_word_up",
                word: a
            })) : (e(".vote-btns .down.pressed").removeClass("pressed"), e(this).addClass("pressed"), e.post(i, {
                clientLog: "word_up",
                word: a
            })) : e(this).hasClass("pressed") ? (e(this).removeClass("pressed"), e.post(i, {
                clientLog: "cancel_word_down",
                word: a
            })) : (e(".vote-btns .up.pressed").removeClass("pressed"), e(this).addClass("pressed"), e.post(i, {
                clientLog: "word_down",
                word: a
            }))
        })
    };
    e("#tPETrans-type-list .p-type").on("click",
    function(t) {
    ...
    l = function() {
        ...
        o = function() {
            ...
            e("#authDictTrans").hasSubMenu(".more", "more-collapse",
            function() {
        ...
        n = function() {
            ...
            e("#eTransform").hasTab(".tabs a", ".tab-content", "tab-current", e.cookie("tabRecord.eTransform"),
            function(t) {
                e.cookie("tabRecord.eTransform", t.rel, o)
            }),
            e("#webTrans").hasTab(".tabs a", ".tab-content", "tab-current", e.cookie("tabRecord.webTrans"),
            function(t) {
                e.cookie("tabRecord.webTrans", t.rel, o)
            }),
            e("#examples").hasTab(".tabs a", ".tab-content", "tab-current", e.cookie("tabRecord.examples"),
            function(t) {
                e.cookie("tabRecord.examples", t.rel, o),
                c()
            }),
            e("#authTrans").hasTab(".tabs a", ".tab-content", "tab-current", e.cookie("tabRecord.authTrans"),
            function(t) {
        ...
        i = function() {
            ...
            return function() {
                e("a.nav-js").click(function(n) {
                    ...
                    i && (i = i.replace(t(), ""), i.length >= 2 && "#" === i.substring(0, 1) ? o(i) : "#" === i && window.scrollTo(0, 0)),
                    n.preventDefault()
                })
            }
        } (),
    ...
    d = function() {
        ...
        n = function(t) {
            ...
            n = e(t).offset();
            /wordbook/.test(t) ? o.html('登录后，生词与PC版、手机版词典同步，随时随地背单词 <a href="http://dict.youdao.com/wordbook/wordlist?keyfrom=notice">登录</a>') : (o.html('登录后，可以提交您的修改 <a href="http://account.youdao.com/login?service=dict&back_url=' + location.href + '" >登录</a>'), n.left += 15, n.top -= 5),
            e("#login_notice_box").size() ? (e("#login_notice_box").css({
                left: 25 + n.left + "px",
                top: -6 + n.top + "px"
            }), e("#login_notice_box").show(), setTimeout(function() {
                e("#login_notice_box").hide()
            },
            2500)) : (e("body").append(o), e("#login_notice_box").css({
                left: 25 + n.left + "px",
                top: -6 + n.top + "px"
            }), e("#login_notice_box").show(), setTimeout(function() {
                e("#login_notice_box").hide()
        ...
        i = function() {
            ...
            function(t) {
                "adddone" === t.message ? (e("#wordbook").attr("title", "已添加，点击编辑单词本"), e("#wordbook").removeClass("add_to_wordbook"), e("#wordbook").addClass("remove_from_wordbook")) : "nouser" === t.message && n("#wordbook")
            }) : e.get("/wordbook/ajax?action=getoneword&q=" + t + "&date=" + (new Date).toString(),
            function(t) {
                ...
                } else "nouser" === t.message && n("#wordbook")
            })
        };
        ...
        document.getElementById("uname") ? e.get("/wordbook/ajax?action=getoneword&q=" + t + "&date=" + (new Date).toString(),
        function(t) {
    ...
    u = function() {
        e("#delword").click(function() {
            var t = encodeURIComponent(e.trim(e("#results h2 .keyword").text()));
            e.get("/wordbook/ajax?action=delword&q=" + t + "&date=" + (new Date).toString(),
            function(t) {
                "1" === t.success && (e("#editwordform").css("display", "none"), e("#wordbook").attr("title", "未添加，点击添加到单词本"), e("#wordbook").removeClass("remove_from_wordbook"), e("#wordbook").addClass("add_to_wordbook"))
            })
        }),
        e("#addword").click(function(t) {
            ...
            function(t) {
                "editdone" === t.message && (e("#editwordform").css("display", "none"), e("#wordbook").attr("title", "已添加，点击编辑单词本"), e("#wordbook").addClass("remove_from_wordbook"))
            })
        });
    ...
    h = function() {
        ...
        a = function(e, a) {
            t[e] = a,
            i < o ? (i += 1, n.push(e)) : (delete t[n.shift()], n.push(e))
        };
...
function() {
    ...
    e.find("a").map(function(e, t) {
        "#" === $(t).attr("href")[0] && ($(t).attr("data-href", $(t).attr("href")), $(t).attr("href", "javascript:void(0);"))
    }),
    e.click(function(e) {
...
function() {
    $(function() {
        ...
        $("#results .more").on("click",
        function() {
            var o = e($(this)) + ".more";
            t(this, o)
        }),
        $(".wt-container .do-detail").on("click",
        function() {
            var o = e($(this)) + ".detail";
            t(this, o)
        }),
    ...
    var e = function() {
        var e = function(e) {
            if ("" !== e && e.indexOf("Toggle") < 0) return e
        };
        return function(t) {
    ...
    t = function(e, t) { (new Image).src = "/ctlog?q=" + $("#query").val() + "&url=" + encodeURIComponent(e.href) + "&pos=1&cfd=1&spt=1&action=CLICK&ctype=" + t
    }
} ();
var docCookies = {
    getItem: function(e) {
    ...
    removeItem: function(e, t) {
        return ! (!e || !this.hasItem(e)) && (document.cookie = escape(e) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT" + (t ? "; path=" + t: ""), !0)
    },
    hasItem: function(e) {
...
function() {
    ...
    function str(e, t) {
        ...
        case "object":
            ...
            if (rep && "object" == typeof rep) for (a = rep.length, o = 0; o < a; o += 1)"string" == typeof rep[o] && (n = rep[o], i = str(n, c), i && r.push(quote(n) + (gap ? ": ": ":") + i));
            else for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (i = str(n, c), i && r.push(quote(n) + (gap ? ": ": ":") + i));
            return i = 0 === r.length ? "{}": gap ? "{\n" + gap + r.join(",\n" + gap) + "\n" + s + "}": "{" + r.join(",") + "}",
            gap = s,
            i
        }
    ...
    "function" != typeof JSON.stringify && (JSON.stringify = function(e, t, o) {
        var n;
        if (gap = "", indent = "", "number" == typeof o) for (n = 0; n < o; n += 1) indent += " ";
...
$(function() {
    ...
    n = function(e) {
        ...
        n.find("i").append(o(e)).delegate(".js_close", "click",
        function() {
            n.remove()
        }),
        $("body").append(n),
    ...
    if (i = i.getMonth() + 1 + "-" + i.getDate(), "-1" != a && i != a) {
        var r, s = navigator.platform.toLocaleLowerCase(),
        c = document.referrer;
        if (s.indexOf("mac") != -1) r = "mac";
        else {
            if (!/win/i.test(s)) return;
            r = "win"
        }
