...
CreatMain:
  ...
  Gui, Show, %isHide% w482 h320, % Lang.1 " v1.5"
return
...
MultiLanguage()
{
  ...
  if (A_Language="0804")
  {
    ...
    ret.25 := "错误 ： "
    ret.26 := "翻译失败，请重试。"
    ret.31 := "自动检测||中文|英语|日语|韩语|德语|法语|俄语|阿拉伯语|爱沙尼亚语|保加利亚语|波兰语|丹麦语|芬兰语|荷兰语|捷克语|拉脱维亚语|立陶宛语|罗马尼亚语|葡萄牙语|瑞典语|书面挪威语|斯洛伐克语|斯洛文尼亚语|泰语|土耳其语|乌克兰语|西班牙语|希腊语|匈牙利语|意大利语|印尼语|越南语"
    ret.32 := "中文||英语|日语|韩语|德语|法语|俄语|阿拉伯语|爱沙尼亚语|保加利亚语|波兰语|丹麦语|芬兰语|荷兰语|捷克语|拉脱维亚语|立陶宛语|罗马尼亚语|葡萄牙语|瑞典语|书面挪威语|斯洛伐克语|斯洛文尼亚语|泰语|土耳其语|乌克兰语|西班牙语|希腊语|匈牙利语|意大利语|印尼语|越南语"
    ret.81 := "DeepL"
    ret.82 := "搜狗"
    ret.83 := "百度"
    ret.84 := "有道"
  ...
  for k, v in Translators
  {
    if (v.initState=1)
    {
      ...
      dict := { 自动检测:"auto",   阿拉伯语:"ar",   爱沙尼亚语:"et"
              ...
              , 瑞典语:"sv",       书面挪威语:"nb", 斯洛伐克语:"sk"
              , 斯洛文尼亚语:"sl", 泰语:"th",       土耳其语:"tr"
              , 乌克兰语:"uk",     西班牙语:"es",   希腊语:"el"
              , 匈牙利语:"hu",     意大利语:"it",   印尼语:"id"
              , 英语:"en",         越南语:"vi",     中文:"zh"}
